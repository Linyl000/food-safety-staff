<template>
	<z-paging
		...
		:use-page-scroll="usid ? true : false"
	>
		<template #top>
			<div style="display: flex;padding: 10rpx;background-color: #fff;" v-if="!usid">
				<u-search
					v-model="name"
					:clearabled="true"
					:showAction="true"
		...
		<div class="peo-box" v-for="(i, index) in dataList" :key="index">
			<div class="people">
				...
				<u-icon name="more-dot-fill" size="26" @click="goChangePeople(i)"></u-icon>
			</div>
			<u-line></u-line>
			<div class="info">
